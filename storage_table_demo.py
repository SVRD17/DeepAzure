# Modified code to for car dealership and coffeeshop
...
car.price = 35000
table_service.insert_entity('itemstable', car)
print('Created entry for Toyota Sienna...')
...
coffee.flavor = 'Cafe Mocha'
coffee.sizeofcup = 'Tall'
coffee.price = 3.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for a Cafe Mocha...\n')
time.sleep(1)
...
coffee.RowKey = '005'
coffee.brand = 'Starbucks'
coffee.flavor = 'Chai tea Latte'
coffee.sizeofcup = 'Tall'
coffee.price = 4.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for a Chai tea latte...\n')
time.sleep(1)
